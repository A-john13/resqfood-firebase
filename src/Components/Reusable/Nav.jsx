  ...
  const renderNavContent = () => {
    switch (userRole) {
      case "1":
        return (
          <>
            <Nav.Link as={Link} to="/user/donate">
              Make Donation
            </Nav.Link>
            <Nav.Link onClick={() => setShowNotifications(!showNotifications)}>
              Notifications
            </Nav.Link>{" "}
            <Nav.Link as={Link} to="/user/role/donprofile">
              Profile
            </Nav.Link>
          </>
        );
      case "2":
        return (
          <>
            ...
            <Nav.Link as={Link} to="/user/role/reciprofile">
              Profile
            </Nav.Link>
          </>
        );
    ...
    <div
      ...
      <Navbar  expand="sm" style={{ fontWeight: "500" }}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">{renderNavContent()}</Nav>
          <Nav>
            {user && UID && (
